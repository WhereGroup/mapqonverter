...
class SymbolPropertiesProvider:
    ...
    def get_polygon_properties(symbol_properties, i_symbol):
        ...
        multilayer_symbol = type_cast_module(i_symbol, ArcGisModules.module_display.IMultiLayerFillSymbol)
        ...
        if multilayer_symbol:
            ...
            for symbol in symbol_collection:
                line_fill_symbol = type_cast_module(symbol, ArcGisModules.module_display.ILineFillSymbol)
                marker_fill_symbol = type_cast_module(symbol, ArcGisModules.module_display.IMarkerFillSymbol)
                gradient_fill_symbol = type_cast_module(symbol, ArcGisModules.module_display.IGradientFillSymbol)

                outline = type_cast_module(symbol.Outline, ArcGisModules.module_display.ILineSymbol)
    ...
    def get_multilayer_line_symbol(i_symbol, symbol_properties):
        ...
        :param i_symbol: this is the used polygon symbol
        """
        multilayer_symbol = type_cast_module(i_symbol, ArcGisModules.module_display.IMultiLayerLineSymbol)
    ...
    def get_point_properties(symbol_properties, i_symbol):
        ...
        symbol_properties['layer'] = []
        multilayer_symbol = type_cast_module(i_symbol, ArcGisModules.module_display.IMultiLayerMarkerSymbol)
