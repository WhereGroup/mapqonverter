...
class LineSymbol:
    ...
    def get_line_symbol_types(i_symbol):
        ...
        """
        line_symbol_type = {}
        symbol_hash_line = type_cast_module(i_symbol, ArcGisModules.module_display.IHashLineSymbol)
        symbol_marker_line = type_cast_module(i_symbol, ArcGisModules.module_display.IMarkerLineSymbol)
        symbol_cartographic_line = type_cast_module(i_symbol, ArcGisModules.module_display.ICartographicLineSymbol)
        symbol_simple_line = type_cast_module(i_symbol, ArcGisModules.module_display.ISimpleLineSymbol)
    ...
    def create_feature_line_symbol(i_symbol):
        ...
        basic_line_symbol = type_cast_module(i_symbol, ArcGisModules.module_display.ILineSymbol)
        try:
    ...
    def create_line_properties(line_symbol, symbol_properties):
        ...
        """
        line_properties = type_cast_module(line_symbol, ArcGisModules.module_display.ILineProperties)
        if line_properties:
