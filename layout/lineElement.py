...
class LineElement(LayoutItem):
    ...
    def create_line_element_content(self, line_element_layout):
        ...
        element_geometry = type_cast_module(self.line_object, ArcGisModules.module_carto.IElement).Geometry
        poly_ine_symbol = type_cast_module(element_geometry, ArcGisModules.module_geometry.IPolyline5)
        point_collection = type_cast_module(poly_ine_symbol, ArcGisModules.module_geometry.IPointCollection)
