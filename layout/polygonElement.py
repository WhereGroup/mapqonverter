...
class PolygonElement(LayoutItem):
    ...
    def create_geometry_element_content(self, polygon_element_layout):
        ...
        symbol = type_cast_module(self.polygon_object, ArcGisModules.module_carto.IFillShapeElement).Symbol
        symbol_properties = {}
        ...
        element_geometry = type_cast_module(self.polygon_object, ArcGisModules.module_carto.IElement).Geometry
        polygon_symbol = type_cast_module(element_geometry, ArcGisModules.module_geometry.IPolygon5)
        point_collection = type_cast_module(polygon_symbol, ArcGisModules.module_geometry.IPointCollection)
