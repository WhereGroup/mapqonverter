...
class Layout:
    ...
    def create_item_content(self, layout_item_type, layout_item, layout_element_dom):
        ...
        if layout_item_type == 'Text':
            layout_text_item = type_cast_module(layout_item, ArcGisModules.module_carto.ITextElement)
            ...
            layout_map_item = type_cast_module(layout_item, ArcGisModules.module_carto.IMapFrame)
            if layout_map_item:
            ...
            fill_symbol_element = type_cast_module(layout_item, ArcGisModules.module_carto.IFillShapeElement)
            ...
            line_symbol = type_cast_module(layout_item, ArcGisModules.module_carto.ILineElement)
            ...
            picture_element_arc = type_cast_module(layout_item, ArcGisModules.module_carto.IPictureElement3)
    ...
    def get_layout_items(self):
        ...
        graphics_container_select = type_cast_module(self.arc_doc.PageLayout,
